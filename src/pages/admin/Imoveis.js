        ...
        <div className="p-6">
                ...
                {imovel.fotos.map((foto, index) => (
                  <img
                    ...
                    className={`w-20 h-20 object-cover rounded cursor-pointer ${
                      currentPhoto === index ? 'ring-2 ring-blue-500' : ''
                    }`}
                  />
                ))}
              </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="font-medium">{imovel.padrao}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-600">Metragem</p>
              <p className="font-medium">{imovel.metragem} m²</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-600">Valor</p>
              <p className="font-medium text-green-600">R$ {imovel.valor?.toLocaleString('pt-BR')}</p>
            </div>
          </div>
